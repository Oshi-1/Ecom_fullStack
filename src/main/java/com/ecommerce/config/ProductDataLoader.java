...
public class ProductDataLoader {
	...
	private Product createProduct(String name, String description, String category, String brand, String price, Integer stock,
			String imageUrl) {
